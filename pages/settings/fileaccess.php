                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select id="modules_accessed<?php echo $file->file_id ?>" class="form-control select2" multiple name="staff_id[]" style="width: 80%;">
                                                                                ...
                                                                                foreach ($staffList AS $staffs) {
                                                                                    $restricted_staff = DB::getInstance()->displayTableColumnValue("select Staff_id from restrict_member where Staff_id='$staffs->staff_id' ", "Staff_id");
                                                                                    $selected = ($restricted_staff == $staffs->staff_id) ? "selected" : "";
                                                                                    echo '<option value="' . $staffs->staff_id . '"' . $selected . '>' . $staffs->name . '</option>';
                                                                                }
                                                                                ?>
                                                                            </select>
                                                                        </div>
