                                                            ...
                                                            <tr> 
                                                                ...
                                                                <td style="width: 20%;">
                                                                    ...
                                                                    <div class="btn-group<?php echo $hide; ?>">
                                                                        ...
                                                                        <a class="btn btn-danger btn-xs" href="index.php?page=<?php echo "file" . '&action=delete&file_id=' . $file->file_id . '&mode=' . $mode; ?>" onclick="return confirm('Are you sure you want to delete <?php echo $file->Question; ?>?');">Delete</a>
                                                                    </div>
